    ...
    <head>
      ...
      <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body { font-family: 'Georgia', 'Times New Roman', serif; color: #1a1a1a; background: #e5e7eb; padding: 10px; }
        .page { position: relative; width: ${pageWidth}; min-height: ${pageHeight}; margin: 0 auto; padding: 0; background: white; }
        ...
        .letterhead-fallback { display: none; text-align: center; padding: 6px; }

        .title { text-align: center; font-size: 15px; font-weight: bold; margin: 8px 0 4px; text-transform: uppercase; letter-spacing: 2px; }
        .subtitle { text-align: center; font-size: 11px; margin-bottom: 8px; color: #555; }

        .info-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 3px; margin-bottom: 8px; font-size: 10px; padding: 5px 8px; border: 1px solid #ddd; background: #fafafa; }
        .info-item { display: flex; }
        .info-label { font-weight: bold; width: 70px; font-size: 9px; }

        table { width: 100%; border-collapse: collapse; margin: 6px 0; font-size: 10px; }
        th { background: #1a56db; color: white; padding: 5px 7px; text-align: left; font-size: 9px; text-transform: uppercase; }
        ...
        .summary-box { flex: 1; padding: 7px 8px; border: 1px solid #ddd; background: #fafafa; font-size: 9px; }
        .summary-item { display: flex; padding: 2px 0; border-bottom: 1px dotted #ccc; }
        .summary-label { font-weight: bold; width: 85px; font-size: 8px; }
        .remarks-box { flex: 1; padding: 7px 8px; border: 1px solid #ddd; font-size: 9px; background: #fafafa; min-height: 40px; }

        .verify-section { margin-top: 5px; padding: 5px 8px; border: 1.5px solid #1a56db; background: #f0f4ff; text-align: center; font-size: 8px; border-radius: 3px; }
        ...
        .sig-line { border-bottom: 1px solid #000; margin-bottom: 2px; height: 22px; }

        .next-term { text-align: center; font-size: 8px; margin-top: 8px; color: #555; }
        .footer { text-align: center; font-size: 7px; margin-top: 6px; padding-top: 3px; border-top: 1px solid #ccc; color: #666; }
        ...
        <div class="content">
          ...
          <div class="summary-section">
            ...
            <div class="remarks-box">
              ...
              <p style="margin-top:3px;">${results?.remarks || '___________________________________________'}</p>
            </div>
          </div>
  ...
  return `
    ...
    <head>
      ...
      <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body { font-family: 'Georgia', 'Times New Roman', serif; color: #1a1a1a; background: #e5e7eb; padding: 8px; }
        ...
        .info-grid { display: grid; grid-template-columns: 1fr 1fr 1fr 1fr; gap: 3px; margin-bottom: 8px; font-size: 10px; padding: 5px 8px; border: 1px solid #ddd; background: #fafafa; }
        .info-item { display: flex; }
    ...
    <head>
      ...
      <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .title { text-align: center; font-size: 14px; font-weight: bold; margin: 5px 0; text-transform: uppercase; letter-spacing: 2px; }
        .info-grid { display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 3px; margin-bottom: 6px; font-size: 9px; padding: 4px 6px; border: 1px solid #ddd; background: #fafafa; }
        .info-item { display: flex; }
        ...
        .verify-section { margin-top: 5px; padding: 4px 6px; border: 1.5px solid #1a56db; background: #f0f4ff; text-align: center; font-size: 8px; border-radius: 3px; }
        .verify-link { font-family: 'Courier New', monospace; font-weight: bold; color: #1a56db; word-break: break-all; }
