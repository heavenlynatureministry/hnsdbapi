...
function ReportsPage() {
  ...
  const recentReports = [
    { name: 'Class P5 Performance', type: 'Academic', date: '2024-02-15', generated_by: 'Admin' },
    { name: 'January Attendance Summary', type: 'Attendance', date: '2024-02-01', generated_by: 'Teacher John' },
    { name: 'Fee Collection Q1', type: 'Financial', date: '2024-01-31', generated_by: 'Accountant' },
  ]
  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
            ...
            {recentReports.map((report, i) => (
              <div key={i} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                <div>
                  ...
                  <p className="text-xs text-gray-500">{report.type} • Generated by {report.generated_by}</p>
                </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          { label: 'Reports Generated', value: '24', icon: FileText, color: 'bg-blue-100 text-blue-600' },
          { label: 'This Month', value: '8', icon: Calendar, color: 'bg-green-100 text-green-600' },
          { label: 'Downloaded', value: '15', icon: Download, color: 'bg-purple-100 text-purple-600' },
          { label: 'Scheduled', value: '3', icon: BarChart3, color: 'bg-orange-100 text-orange-600' },
        ].map((stat, i) => (
